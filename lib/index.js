...
function debounce(fn, delay) {
  ...
  return function (event) {
    ...
    t = setTimeout(function () {
      ...
      if (state) {
        win[SCROLL_TO](state.scrollWidth, state.scrollTop)
      }
    }, delay)
  }
}
...
function go(path, title, shouldReplace) {
  ...
  let state = {
    scrollWidth: (doc[DOCUMENT_ELEMENT] && doc[DOCUMENT_ELEMENT].scrollWidth) || doc.body.scrollWidth,
    scrollTop:   (doc[DOCUMENT_ELEMENT] && doc[DOCUMENT_ELEMENT].scrollTop) || doc.body.scrollTop
  }
